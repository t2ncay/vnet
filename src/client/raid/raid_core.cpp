...
// ============================================================
static const float RAID_TRIGGER_HIGH_TRACE = 0.0012f;
static const float RAID_TRIGGER_MED_TRACE  = 0.0006f;
static const float RAID_TRIGGER_LOW_TRACE  = 0.00025f;
static const float RAID_TRIGGER_FLAGGED_MULT = 1.3f;

// ------------------------------------------------------------
// Init, Reset, Trigger, Update, Choice, Minigame, Success/Failure
// All the functions from the original raid.cpp (excluding sequence & draw)
// ------------------------------------------------------------
